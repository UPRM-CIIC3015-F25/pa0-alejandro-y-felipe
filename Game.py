...
def ball_movement():
    ...
    if start:
        ...
        ball_speed_y = 10 * random.choice ((1, -1))# Randomize initial vertical direction
        start = False
...
while True:
    ...
    pygame.draw.rect(screen, yellow , player)  # Draw player paddle
    # TODO Task 3: Change the Ball Color
    pygame.draw.ellipse(screen, yellow, ball)  # Draw ball
    player_text = basic_font.render(f'{score}', False, yellow)  # Render player score
